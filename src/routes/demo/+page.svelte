...
<main class="relative flex h-[calc(100vh-85px)] w-full flex-col items-center justify-center">
	<div class="z-10 flex flex-col items-center justify-center">
		<h1 class="text-5xl lg:text-8xl font-bold uppercase">[Your Game]</h1>
		<div class="mt-20 flex flex-col gap-4 relative text-center">
			<Button class="w-60 cursor-not-allowed">Play <Play strokeWidth={3} /></Button>
			<Button
				class="w-60"
				variant="outline"
				onclick={() => {
					playlightSDK?.setDiscovery(true);
				}}>More Games <Joystick /></Button
			>
